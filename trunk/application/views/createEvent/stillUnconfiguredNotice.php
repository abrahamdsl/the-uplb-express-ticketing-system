...
<div id="main_container">
    ...
    <div id="main_content" >    	
    	<div id="centralContainer">           		   
			<div id="page_title">
				Configure other showing times of ' <?php echo $_COOKIE['eventName']; ?> '
			</div>
					...
					<div id="content">						
						...
						<form method="post"  action="<?php echo base_url().'EventCtrl/create_step4' ?>" name="formLogin" id="formMain">
							...
							<div id="essentialButtonsArea">							
								<a class="button" id="buttonOK" ><span class="icon">Yes</span></a>														
								<a class="button" id="buttonReset" ><span class="icon">No</span></a>
							</div>	
						</form>
						<form method="post"  action="<?php echo base_url(); ?>" id="formReturnHome" ></form>
					</div>
				</div>												
			</div>
			<!-- accordion end -->
