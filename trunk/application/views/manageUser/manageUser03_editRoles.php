...
?>
	...
	<script type="text/javascript" src="<?php echo base_url().'assets/javascript/form-validation/manageuser03_editroles.js'; ?>" ></script>
...
<div id="main_container">
    ...
    <div id="main_content">
    	<div id="centralContainer" class="homepageSpecial" > 
			...
			<div id="instruction">
				<ul>
					<li>Roles that are grayed out mean they are not currently enabled for the user. Click the tile
				representing the role to enable it. When done, click Save.</li>
					<li>The customer role cannot be removed.</li>
				</ul>
			</div>
			<!-- accordion start -->
			...
			<div id="accordion" class="specialOnMB01" >
				...
				<div id="x1" class="section" >
					...
					<div class="containingClassTable">
						<form method="post" action="useracctctrl/manageuser_editrole_save" id="formMain" >
