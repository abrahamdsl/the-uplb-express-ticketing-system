			...
			<div id="accordion" class="specialOnMB01" >
				...
				<div id="x<?php echo $singleSeatmap->UniqueID; ?>" class="section" >
					...
					<div class="containingClassTable" >
						<?php
							$uid = $singleSeatmap->UniqueID;
						?>
						<div class="metrotile mtile5" name="edit">
							<a href="<?php echo base_url().'seatctrl/editseatmap/'.$uid; ?>">
								<img src="<?php echo base_url(); ?>assets/images/metrotiles/uxt-genericedit.png" alt="Edit payment mode" />
							</a>
						</div>
						<div class="metrotile mtile3" name="delete">
							<a href="<?php echo base_url().'seatctrl/deleteseatmap/'.$uid; ?>">
