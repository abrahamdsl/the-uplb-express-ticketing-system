...
?>
	...
	<script type="text/javascript" src="<?php echo base_url().'assets/javascript/form-validation/attend01.js'; ?>"></script>	
	<!--For modal v1-->	
				...
				<div id="accordion" >
					...
					<form method="post"  action="#" name="formLogin" id="formMain" >						
						<div>
							...
							<div class="mainWizardMainSections" >
								<span class="MWMS1" >
									Surname of any of the guests									
								</span>
								<span class="MWMS2" ><input type="text" name="surname" class="textInputSize" /></span>					
								<span class="MWMShidden fieldErrorNotice NameRequired" >This is not allowed to be blank</span>
								<span class="MWMShidden fieldErrorNotice" id="ajaxind2" >
									<img title="ajaxloader" src="<?php echo base_url().'assets/images/ajax-horiz.gif'; ?>" alt="ajax_loader" />
								</span>									
							</div>		
							-->							
