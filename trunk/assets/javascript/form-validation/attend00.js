...
$(document).ready( function() {			
	...
	$('select#eventSelection').change( function(){
		...
		var requestST_POST = $.ajax({
			type: 'POST',
			url: CI.base_url + "eventctrl/getForCheckInShowingTimes" , // URL, CI.base_url found in the page
			timeout: 40000,
	...
	$('#buttonOK').click( function(){
		...
		if( selectedSchedule == "NULL" || $('select#showingTimeSelection option:selected').size() < 1 )
		{			
			$.fn.nextGenModal({
			   msgType: 'error',
			   title: 'input needed',
